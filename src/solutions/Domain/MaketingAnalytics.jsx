...
import {
  BarChart3, Globe2, LineChart, Radar, TrendingUp, Search, Eye, Zap, ArrowRight, Sparkles
} from 'lucide-react';
import AOS from "aos";
import "aos/dist/aos.css";
import competitor_intelligence from "./competitor_intelligence.jpg"
import market_trend from "./market_trend.jpg"
import opportunity_sizing from "./opportunity_sizing.jpg"
import demand_forecasting from "./demand_forecasting.jpg"
...
},
{
  ...
  const benefits = [
    { icon: <TrendingUp className="w-6 h-6" />, text: "Smarter Market Entry" },
    { icon: <BarChart3 className="w-6 h-6" />, text: "Real-Time Trend Visibility" },
    { icon: <Eye className="w-6 h-6" />, text: "Competitive Clarity" },
    { icon: <Zap className="w-6 h-6" />, text: "Faster Strategic Response" }
  ];
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8 z-10">
                  <div className="text-center">
                    ...
                    <h2 className="text-2xl md:text-4xl font-bold mb-8 text-gray-100 animate-fade-in-up delay-200">
                      Make Confident,   <span className="text-red-400">Competitive Moves</span>
                    </h2>
                    <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-12 animate-fade-in-up delay-400">
                        Transform how you understand your market. Our solutions help you track trends, competitors, and demand — all in real time.
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                  <div className="text-center mb-16">
                    <h2 className="text-5xl md:text-6xl font-black mb-6 animate-fade-in-up">
                      Our <span className="text-red-400">Market Intelligence</span> Arsenal
                    </h2>
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto animate-fade-in-up delay-200">
                      Gain a strategic edge with insights into market dynamics, customer needs, and competitive forces.
                    </p>
                  </div>
              ...
              <section className="py-20 bg-gradient-to-r from-red-950/20 via-black to-red-950/20 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
                  <h2 className="text-5xl md:text-6xl font-black mb-6 animate-fade-in-up">
                    Want to Outpace  <span className="text-red-400">the Market?</span>
                  </h2>
                  <p className="text-xl text-gray-300 mb-8 leading-relaxed animate-fade-in-up delay-200">
                    Let us equip you with the tools to see around corners, anticipate demand, and take decisive action — before your competition does.
                  </p>
