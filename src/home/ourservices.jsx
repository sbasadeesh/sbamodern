  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-2xl p-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-pulse"></div>
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <button className="relative hover:cursor-pointer inline-flex items-center justify-center px-6 py-3 font-medium text-white bg-[#1F1D1A] rounded-lg overflow-hidden transition-all duration-1000 group-hover:bg-gray-200 group-hover:text-black w-full">
