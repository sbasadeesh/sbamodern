...
import { Heart, Activity, Stethoscope, Brain, Shield, ArrowRight, Monitor, Zap, Network, Users, FileText, Eye } from 'lucide-react';
import AOS from "aos";
...
const HealthcareLandingPage = () => {
  ...
  const benefits = [
    { icon: <Zap className="w-6 h-6" />, text: "Accelerate Diagnostics" },
    { icon: <Heart className="w-6 h-6" />, text: "Enhance Patient Care" },
    { icon: <Network className="w-6 h-6" />, text: "Intelligent Automation" },
    { icon: <Shield className="w-6 h-6" />, text: "Clinical Excellence" }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-1/3 right-1/4 w-36 h-36 bg-red-500/10 rounded-full blur-xl animate-pulse delay-700"></div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex justify-center items-center gap-3 mb-4">
            <div className="relative">
              ...
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full opacity-75"></div>
            </div>
          ...
          <p className="text-gray-400">
            Empowering Healthcare Excellence Through Intelligent Medical Technology
          </p>
        </div>
      </footer> */}
    </div>
