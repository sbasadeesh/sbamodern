...
import { Brain, Eye, Code, MessageSquareText, TrendingUp, Users, Lock, Zap, ArrowRight } from 'lucide-react';
import AOS from "aos";
...
const MachineLearning = () => {
  ...
  const benefits = [
    { icon: <Zap className="w-6 h-6" />, text: "Automated Intelligence" },
    { icon: <Brain className="w-6 h-6" />, text: "Smarter Decisions" },
    { icon: <Users className="w-6 h-6" />, text: "Enhanced User Experience" },
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold mb-8 text-gray-100">
              Intelligent Systems, Ready to Deploy
            </h2>
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-12">
              Build intelligent systems with our ready-to-integrate machine learning models. From 
              predictive analytics to natural language processing, we tailor solutions to match your business needs.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Our <span className="text-blue-400">ML Capabilities</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Scalable machine learning models built for real-world impact across industries.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-900/20 via-black to-indigo-900/20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Deploy <span className="text-blue-400">Intelligent Models</span>?
          </h2>
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Let’s help you unlock the full potential of machine learning with secure, scalable, and customizable solutions.
          </p>
