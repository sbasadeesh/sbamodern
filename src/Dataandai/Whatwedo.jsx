  ...
  const platformFeatures = [
    {
      ...
      title: "Augment Human Expertise with AI",
      description: "Enhance decision-making by pairing human intelligence with real-time insights from AI. Empower your workforce to focus on high-value tasks, not manual analysis.",
    ...
    },
    {
      ...
      description: "Deploy machine learning models faster and with confidence. Automate workflows, monitor performance, and drive outcomes with responsible, explainable AI tailored to your business needs.",
    ...
    },
    {
      ...
      description: "Leverage pre-built data pipelines, model templates, and intelligent automations to move from idea to impact in weeks — not months.",
