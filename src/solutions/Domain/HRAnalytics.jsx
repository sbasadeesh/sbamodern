...
import {
  Users, BadgeCheck, TrendingDown, BarChart4, Smile, LineChart, Gauge, Zap, ArrowRight, Sparkles
} from 'lucide-react';
import AOS from "aos";
...
const HRAnalytics = () => {
 ...
 const sectionRefs = useRef([]);
  ...
  const benefits = [
    { icon: <Users className="w-6 h-6" />, text: "People-Centric Decisions" },
    { icon: <LineChart className="w-6 h-6" />, text: "Predictive Workforce Insights" },
    { icon: <BarChart4 className="w-6 h-6" />, text: "Performance Visibility" },
    { icon: <Zap className="w-6 h-6" />, text: "Proactive Retention" }
  ];
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8 z-10">
              <div className="text-center">
                ...
                <h2 className="text-2xl md:text-4xl font-bold mb-8 text-gray-100 animate-fade-in-up delay-200">
                  Empowering People  <span className="text-red-400">with Data</span>
                </h2>
                <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-12 animate-fade-in-up delay-400">
                    Use actionable workforce data to improve recruitment, reduce turnover, and create high-performing, engaged teams.
                </p>
          ...
          <section className="py-20 bg-gradient-to-r from-red-950/20 via-black to-red-950/20 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed animate-fade-in-up delay-200">
                Let’s turn your HR data into a strategic advantage — to hire smarter, retain longer, and perform better.
              </p>
