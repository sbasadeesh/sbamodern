...
import {
  Brain, Eye, Code, MessageSquareText,
  TrendingUp, Users, Lock, Zap, ArrowRight, BarChart, LayoutDashboard
} from 'lucide-react';
import AOS from "aos";
...
const AIIntegrations = () => {
  ...
  const benefits = [
    { icon: <Zap className="w-6 h-6" />, text: "Seamless Integration" },
    { icon: <Brain className="w-6 h-6" />, text: "AI-Powered Workflows" },
    { icon: <Users className="w-6 h-6" />, text: "Enhanced Experiences" },
    { icon: <Lock className="w-6 h-6" />, text: "Secure & Scalable" }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold mb-8 text-gray-100">
              Intelligent Experiences, Seamlessly Delivered
            </h2>
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-12">
              Seamlessly integrate AI into your tools, workflows, and customer interactions. From chatbots to dashboards and predictions, we build AI solutions that enhance both efficiency and experience.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              AI <span className="text-blue-400">Integration Solutions</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Future-ready AI integrations designed to scale with your business and delight your users.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-900/20 via-black to-indigo-900/20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to <span className="text-blue-400">Integrate AI</span> into Your Workflow?
          </h2>
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Discover how our AI solutions can be embedded into your systems for maximum performance, personalization, and productivity.
          </p>
